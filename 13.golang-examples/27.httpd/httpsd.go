...
func genCert() {
	ca := &x509.Certificate{
		...
		Subject: pkix.Name{
			Country:            []string{"anonymous"},
			Organization:       []string{"SubjectOrganization"},
			OrganizationalUnit: []string{"SubjectOrganizationalUnit"},
		},
		Issuer: pkix.Name{
			Country:            []string{"anonymous"},
			Organization:       []string{"IssuerOrganization"},
			OrganizationalUnit: []string{"IssuerOrganizationalUnit"},
			Locality:           []string{"anonymous"},
			Province:           []string{"anonymous"},
			StreetAddress:      []string{"Mainstreet 1"},
